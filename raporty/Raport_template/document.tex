...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Temat:      & ... Wpisać temat ...                                                          &  &  &  &  \\
		Grupa:      & IS-2(s)P1  & Nr raportu: & 1 & Data: & 08.10.2023 \\
...
\textit{Co udało się wykonać} % Usunąć

\section{Niewykonane zadania}

\textit{Czego nie udało się wykonać} % Usunąć

\section{Napotkane problemy}

\textit{Jakie pojawiły się problemy} % Usunąć

\section{Zadania na kolejny tydzień}

\textit{Jakie są plany na kolejny tydzień} % Usunąć

\section{Stan dokumentacji projektowej}

\textit{Jakie są postępy z dokumentacją projektową od ostatniego spotkania} % Usunąć
