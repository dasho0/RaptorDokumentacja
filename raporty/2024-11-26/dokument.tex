...
\begin{table}[h!]
	...
	\begin{tblr}{
		...
		Temat:      & Raptor                                                         &  &  &  &  \\
		Grupa:      & IS-2(s)P3  & Nr raportu: & 4 & Data: & 26.11.2024 \\
...
-Dodanie działającego odtwarzacza który jest jedną z głównych części aplikacji.\\
-Wprowadzenie poprawek do NavHosta.\\
-Dlasza praca nad bazdanych, jest bardziej skomplikowana ni zakadano.\\
-Dodanie Topbara
\section{Niewykonane zadania}

\section{Napotkane problemy}
-Podczas modyfikacji NavHost albumid tymczasowo pobierał stringa z nazwy.

\section{Zadania na kolejny tydzień}
-Dokończenie niewykonanych zadań, oraz dodanie biometryki oraz czujnika światła.
